module QDL::Type
  ...
  class TupleType < Type
    ...
    def promote(t=nil)
      ...
      param = (@params.empty? && !t) ? QDL::Type::VarType.new(:t) : UnionType.new(*@params.map { |p| if p.is_a?(QDL::Type::SingletonType) && !p.val.nil? then p.nominal else p end }, t)
      param = param.widen if QDL::Config.instance.promote_widen
      GenericType.new(QDL::Globals.types[:array], param)
    end
