module QDL::Type
  ...
  class PreciseStringType < Type
    ...
    ## For interpolated strings, it will include strings and QDL types, in order, where the types represent
    ...
    def canonical
      return QDL::Globals.types[:string] if @promoted
      return self
    end

    def to_s
      return QDL::Globals.types[:string].to_s if @promoted
    ...
    def ==(other)
      ...
      return QDL::Globals.types[:string] == other if @promoted
