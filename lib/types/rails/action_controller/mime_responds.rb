QDL.nowrap :'ActionController::MimeResponds'

QDL.type :'ActionController::MimeResponds', :respond_to,
  ...
  module MimeResponds
    class Collector
      Mime::EXTENSION_LOOKUP.each { |mime|
        QDL.type :'ActionController::MimeResponds::Collector', :method_missing,
